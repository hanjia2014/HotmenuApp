...
namespace HotmenuApp.Migrations
{
    ...
    partial class applicationDbInit
    {
        ...
        {
            get { return "20150805233150_applicationDbInit"; }
        }
        ...
        public override void BuildTargetModel(ModelBuilder builder)
        {
            ...
            builder.Entity("HotmenuApp.Areas.Admin.Models.ApplicationUser", b =>
                {
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("HotmenuApp.Areas.Admin.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
